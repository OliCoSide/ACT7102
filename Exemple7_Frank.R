...
TVaRkX1 <- function(k) 1/(1-k)*sum(densM1(0:500)*(0:500)*0.5/0.1*pgamma(VaRkX1(k),(0:500)*0.5+1,0.1))
TVaRkX2 <- function(k) 1/(1-k)*sum(densM2(0:500)*(0:500)*0.25/0.1*pgamma(VaRkX2(k),(0:500)*0.25+1,0.1))
